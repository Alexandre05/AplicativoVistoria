...
import kotlinx.android.synthetic.main.fragment_verify_phone2.*

import java.util.concurrent.TimeUnit


class VerifyPhoneFragment2: Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_verify_phone2, container, false)
    }
    ...
    private val phoneAuthCallbacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        override fun onVerificationFailed(exception: FirebaseException) {
            ...
            override fun onCodeSent(verificationId: String,
                ...
                this@VerifyPhoneFragment2.verificationId = verificationId
            }
        }
        ...
        FirebaseAuth.getInstance()
            ...
            ?.addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    ...
                    val action = VerifyPhoneFragment2Directions.actionPhoneVerified()
